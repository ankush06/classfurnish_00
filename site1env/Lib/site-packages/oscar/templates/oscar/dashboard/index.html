...
<div class="row">
    <div class="col-md-4">
        <table class="table table-striped table-bordered table-hover">
		<caption><i class="icon-gift icon-large"></i>{% trans "Available Partner" %}</caption>
		<tr>
            <th class="col-md-10">{% trans "Active <em>Partner</em>" %}</th>
            <td class="col-md-2" >{{ total_active_partner }}</td>
        </tr>
		<tr>
            <th class="col-md-10">{% trans "Total <em>Partner</em>" %}</th>
            <td class="col-md-2" >{{ partner_count }}</td>
        </tr>
		</table>
    </div>
</div>
